...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.tangram, this.pyramid, this.cone, this.plane, this.unitCube, this.prism, this.cylinder];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Tangram': 0 , 'Pyramid': 1, 'Cone': 2, 'Plane': 3, 'Unit Cube': 4, 'Prism': 5, 'Cylinder': 6};
    ...
    initMaterials() {
        ...
        this.wood.setAmbient(0.4, 0.25, 0.2, 1.0);
        this.wood.setDiffuse(0.6, 0.4, 0.3, 1.0);
        this.wood.setSpecular(0.1, 0.05, 0, 1.0);
        this.wood.setShininess(8.0);
        ...
        this.materials = [this.wood, this.material1, this.material2, this.material3, this.customMaterial];

        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Wood': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom': 3, 'Red Ambient': 4};
    }
    display() {
